const { queryNearbyIssues } = require('./issueService');
const { findNearbyIssue } = require('../utils/geospatialUtils');
const { createIssueViaAppSync, createReportViaAppSync } = require('./appsyncService');

exports.associateOrCreateIssueForReport = async ({ reportId, latitude, longitude, category, description, imageUrl }) => {
    try {
