...
export 'ContractorSubscription.dart';
export 'GovernmentEntity.dart';
export 'Issue.dart';
...
class ModelProvider implements amplify_core.ModelProviderInterface {
  @override
  String version = "15bca1eb87ffb8571d26d1d2df718bf9";
  @override
  ...
  amplify_core.ModelType getModelTypeByModelName(String modelName) {
    switch(modelName) {
      ...
      case "ContractorSubscription":
        return ContractorSubscription.classType;
      ...
      case "RequestForProposal":
        return RequestForProposal.classType;
      case "Upvote":
