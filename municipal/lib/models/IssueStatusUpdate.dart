...
class IssueStatusUpdate extends amplify_core.Model {
  ...
  IssueStatusUpdateModelIdentifier get modelIdentifier {
      return IssueStatusUpdateModelIdentifier(
        id: id
      );
  }
  ...
  const IssueStatusUpdate._internal({required this.id, required issueId, required issueCategory, required issueImageUrl, required status, createdAt, updatedAt}): _issueId = issueId, _issueCategory = issueCategory, _issueImageUrl = issueImageUrl, _status = status, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory IssueStatusUpdate({String? id, required String issueId, required IssueCategory issueCategory, required String issueImageUrl, required IssueStatus status}) {
  ...
  String toString() {
    ...
    buffer.write("issueCategory=" + (_issueCategory != null ? amplify_core.enumToString(_issueCategory)! : "null") + ", ");
  ...
  IssueStatusUpdate copyWith({String? issueId, IssueCategory? issueCategory, String? issueImageUrl, IssueStatus? status}) {
    return IssueStatusUpdate._internal(
      id: id,
  ...
  IssueStatusUpdate copyWithModelFieldValues({
    ...
    return IssueStatusUpdate._internal(
      ...
      issueCategory: issueCategory == null ? this.issueCategory : issueCategory.value,
      issueImageUrl: issueImageUrl == null ? this.issueImageUrl : issueImageUrl.value,
  ...
  IssueStatusUpdate.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _issueCategory = amplify_core.enumFromString<IssueCategory>(json['issueCategory'], IssueCategory.values),
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'issueId': _issueId, 'issueCategory': amplify_core.enumToString(_issueCategory), 'issueImageUrl': _issueImageUrl, 'status': amplify_core.enumToString(_status), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final amplify_core.QueryModelIdentifier<IssueStatusUpdateModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<IssueStatusUpdateModelIdentifier>();
  static final ID = amplify_core.QueryField(fieldName: "id");
  static final ISSUEID = amplify_core.QueryField(fieldName: "issueId");
  static final ISSUECATEGORY = amplify_core.QueryField(fieldName: "issueCategory");
  static final ISSUEIMAGEURL = amplify_core.QueryField(fieldName: "issueImageUrl");
...
class _IssueStatusUpdateModelType extends amplify_core.ModelType<IssueStatusUpdate> {
 ...
 */
class IssueStatusUpdateModelIdentifier implements amplify_core.ModelIdentifier<IssueStatusUpdate> {
  final String id;

  /** Create an instance of IssueStatusUpdateModelIdentifier using [id] the primary key. */
  const IssueStatusUpdateModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is IssueStatusUpdateModelIdentifier &&
      id == other.id;
  }
